    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _advanceController.text = orderData['advance'] != null
              ? orderData['advance'].toString()
              : '';
          _isLoading = false;
        });
      } else {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          // participates in the pop transition, and popping the instant it
          // appears crashes with "multiple heroes share the same tag". Let
          // the caller show the confirmation once back on its own screen.
